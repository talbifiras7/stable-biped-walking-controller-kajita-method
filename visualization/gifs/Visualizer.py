...
def plot_timeseries(zmp: ZMPData, com: CoMTrajectory,
    ...
    plt.tight_layout()
    _save(fig, os.path.join(outdir, "zmp_com_timeseries.png"))
...
def plot_topview(zmp: ZMPData, com: CoMTrajectory,
    ...
    _save(fig, os.path.join(outdir, "zmp_com_topview.png"), tight=False)
...
def plot_com_state(com: CoMTrajectory, outdir: str) -> None:
    ...
    plt.tight_layout()
    _save(fig, os.path.join(outdir, "com_state.png"))
...
def animate_topview(zmp: ZMPData, com: CoMTrajectory,
    ...
    path = os.path.join(outdir, "walk_topview.gif")
...
def animate_sideview(zmp: ZMPData, com: CoMTrajectory,
    ...
    path = os.path.join(outdir, "walk_sideview.gif")
    anim.save(path, writer=PillowWriter(fps=25))
    plt.close(fig)
    print(f"  saved → {path}")
